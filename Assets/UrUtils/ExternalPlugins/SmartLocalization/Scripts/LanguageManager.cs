...
namespace SmartLocalization
{
    ...
    public class LanguageManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        List<string> serializedKeys = null;
        [SerializeField, HideInInspector]
        List<LocalizedObject> serializedValues = null;
        [SerializeField, HideInInspector]
        SmartCultureInfo serializedCulture = null;
        ...
        bool LoadAvailableCultures()
        {
            ...
            TextAsset availableCulturesXML = Resources.Load(path) as TextAsset;
