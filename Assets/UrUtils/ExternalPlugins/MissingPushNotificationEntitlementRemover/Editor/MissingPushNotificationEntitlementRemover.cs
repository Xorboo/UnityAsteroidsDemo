...
public class MissingPushNotificationEntitlementRemover
{
    ...
    static class UnityPre550Remover
    {
        ...
        static string regexpForNotificationMethods = "-\\s?\\(void\\)application:\\(UIApplication\\s?\\*\\)application\\sdid.+RemoteNotification.+\\n?{[^-|#.+]+";
    ...
    static class UnityPost550Remover
    {
        public static string preprocessorHeaderFile = "Preprocessor.h";

        static string regexpForNotificationMethods = "define UNITY_USES_REMOTE_NOTIFICATIONS 1";
